...
public class AdminRestaurantController {
    ...
    public String edit(@PathVariable(name = "id") Integer id, Model model) {
        ...
        RestaurantEditForm restaurantEditForm = new RestaurantEditForm(restaurant.getId(), restaurant.getName(), null, restaurant.getDescription(), restaurant.getLowestPrice(), restaurant.getHighestPrice(), restaurant.getCapacity(), restaurant.getPostalCode(), restaurant.getAddress(), restaurant.getPhoneNumber(), restaurant.getBusinessHours(), restaurant.getRegularHoliday(), restaurant.getCategory());
